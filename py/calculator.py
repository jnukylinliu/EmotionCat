...
# 输入数据
volume = [17300, 16359, 16772,18198,17150,17991,17210,20805,18968,16247,14356,14938,19065,18182]
limit_up = [140, 84, 95,74,200,113,597,282,213,339,396,287,448,236]
limit_down = [2, 68, 17,244,94,699,164,157,85,169,94,41,26,126]
consecutive_up_days = [3, -1, 1,-1,1,-1,1,-1,-2,-2,1,2,3,-1]
index_change = [0.56, -0.12, 0.85,-0.42,0.43,-0.93,0.81,-0.18,-0.8,-0.12,0.22,0.53,1.17,-0.25]
