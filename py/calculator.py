from strategy import get_score_volume,get_score_limitup,get_score_limitdown,get_score_updays,get_score_index
...
# 输入数据
volume = [17300, 16359, 16772,18198,17150,17991,17210,20805]
limit_up = [140, 84, 95,74,200,113,597,282]  
limit_down = [2, 68, 17,244,94,699,164,157]  
consecutive_up_days = [3, -1, 1,-1,1,-1,1,-1]
index_change = [0.56, -0.12, 0.85,-0.42,0.43,-0.93,0.81,-0.18]
